...
export default function ProposalList({ dao, walletConnected, newProposal, setNewProposal, walletAddress }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Card.Root className="col-span-1 md:col-span-2 bg-white/10 p-4 rounded-lg">
        <Card.Header>
        ...
        <Card.Content>
          ...
          {dao.proposals.map(pr => (
            <Card.Root key={pr.id} className="bg-white/10 p-4 rounded-lg mt-4">
              <Card.Header>
                <Card.Title>{pr.title}</Card.Title>
                <Card.Description className="text-sm text-white/70">{pr.description}</Card.Description>
              </Card.Header>
              <Card.Content>
          ...
          {dao.pendingChanges.map(ch => (
            <Card.Root key={ch.id} className="bg-white/10 p-4 rounded-lg mt-4">
              <Card.Content>
